...
class MainCategory(models.Model):
    ...
    image = models.ImageField(_('عکس'), upload_to='category-and-brands/', null=True, blank=True)
    parent = models.ForeignKey('self', on_delete=models.PROTECT, null=True, blank=True, verbose_name='زیر دسته',
...
class ProductFeature(models.Model):
    product = models.ForeignKey('Product', related_name='features', on_delete=models.PROTECT, verbose_name='محصول')
...
class Product(models.Model):
    ...
    price = models.DecimalField(_('قیمت'), max_digits=12, decimal_places=3)
    discount = models.PositiveSmallIntegerField(_('تخفیف (%)'), default=0, validators=(MinValueValidator(0),))
    unit_type = models.PositiveSmallIntegerField(_('واحد'), default=1, choices=[(1, 'عدد'), (2, 'کیلو')])
    quantity = models.DecimalField(_('تعداد'), default=1.0, max_digits=12, decimal_places=3)
